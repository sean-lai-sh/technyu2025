  ...
  return (
    <section id='history' className='pt-5'>
        ...
        <div className='px-[5vw] text-white text-lg md:text-xl lg:text-2xl mt-6 w-full space-y-4'>
          <p>Our alumni and collaborators sit across startups, big tech, product, design, and infrastructure. The logos are not the point. They are proof that the club has range, memory, and a real network of people who keep building.</p>
        ...
        <h2 className='px-[5vw] text-4xl py-10 font-bold'>Proof We Build in Real Rooms</h2>
        <LogoSlider
