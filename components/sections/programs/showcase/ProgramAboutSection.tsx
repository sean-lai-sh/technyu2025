...
export default function ProgramAboutSection({
  ...
  return (
    <section className="px-[5vw] lg:px-[8vw] py-[10svh] border-t border-[#EDEDED]/8">
      ...
      <h2
        className="font-[family-name:var(--font-satoshi)] font-medium leading-[0.92] text-[#EDEDED] mb-16"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cards.map((card, i) => (
          ...
          >
            ...
            <div>
              <h3
                className="font-[family-name:var(--font-satoshi)] font-medium text-[#EDEDED] mb-3 whitespace-pre-line leading-tight"
