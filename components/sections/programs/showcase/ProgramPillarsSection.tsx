...
export default function ProgramPillarsSection({
  ...
  return (
    <section className="px-[5vw] lg:px-[8vw] py-[10svh] border-t border-[#EDEDED]/8">
      ...
      <h2
        className="font-[family-name:var(--font-hk-grotesque)] font-medium leading-[0.92] text-[#EDEDED] mb-12"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {pillars.map((pillar, index) => (
          ...
          >
            ...
            <h3
              className="font-[family-name:var(--font-hk-grotesque)] text-[#EDEDED] leading-tight mb-3"
